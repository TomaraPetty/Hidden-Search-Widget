...
<a href="https://tomarapetty.github.io/Hidden-Search-Widget/">Click here to see it in action.</a>
...
* Hidden search widget is not a stand alone application, it can be incorporated into any project that has a search bar. The search bar is retractable and is activated only when the user clicks on the search icon. 
...
* Hidden search widget gives search bars in your application a smooth design that feels interactive to the user. 
